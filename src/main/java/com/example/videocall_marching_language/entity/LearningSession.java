...
public class LearningSession {
    ...
    @Column(name = "accumulated_overlap_seconds", nullable = false)
    @Builder.Default
    private Integer accumulatedOverlapSeconds = 0;
    ...
    @Column(name = "user1_uid")
    private Integer user1Uid;

    @Column(name = "user2_uid")
    private Integer user2Uid;
